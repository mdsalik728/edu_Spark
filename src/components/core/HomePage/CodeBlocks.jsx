...
const CodeBlocks = ({
  ...
  return (
    ...
    <div
      className={`flex ${position} flex-col justify-between gap-5 my-auto w-[100%]`}
    >
      {/*Section 1*/}
      ...
      {/*Section 2*/}
      <div className=" h-fit flex text-[12px] w-[100%] py-4 md:w-[45%] lg:w-[500px] relative bg-black rounded-md">
        ...
        <div
          className={`w-[90%] flex flex-col gap-2 font-bold font-mono ${codeColor} pr-2 z-10 md:text-[12px] lg:text-[15px] `}
        >
          <TypeAnimation
