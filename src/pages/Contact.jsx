...
const Contact = () => {
  return (
    <div>
      ...
      <div className="w-11/12 mx-auto text-richblack-900 my-8 max-w-maxContent  overflow-hidden">
        <ContactMap />
      </div>
      <div className="relative mx-auto  my-20 flex w-11/12  max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-richblack-900">
