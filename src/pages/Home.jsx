...
const Home = () => {
  return (
    <div className="mt-9">
      ...
      text-richblack-900 justify-between"
      >
      ...
      <div className="bg-pure-greys-5 text-richblack-700">
        <div className="h-[333px] homepage_bg">
          <div className="w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-5 mx-auto">
            ...
            <div className="text-richblack-900 flex gap-7 ">
              <CTAButton active={true} linkto={"/signup"}>
          ...
          <div className="flex flex-row gap-10 mb-10 mt-[100px] max-sm:flex-col w-[90%] max-sm:mt-[30px]">
            ...
            <div className="flex flex-col gap-8 w-[40%] items-start max-sm:w-[100%] text-center">
              <div className="text-[16px]">
                The modern EduSpark is the dictates its own terms. Today, to be
      ...
      {/*Section 3 */}
      <div className="w-11/12 mx-auto max-w-maxContent flex flex-col items-center justify-between gap-8 bg-richblack-900 text-richblack-900">
        <InstructorSection />
